...
from 0.1 to 1.0. Evaluation uses friction 0.1 on a fixed uphill slope with a 0.4
gradient (approximately 21.8 degrees). The 16-by-16-meter terrain provides four
